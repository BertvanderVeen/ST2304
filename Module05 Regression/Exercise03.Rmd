...
**Due midnight 17th February 2024**
...
DragonFire <- read.csv(file="https://www.math.ntnu.no/emner/ST2304/2024v/Module05/DragonFire.csv")
...
<span style="color:blue"> 1.8. How would you interpret these confidence intervals for the prediction? i.e. give 
...
<span style="color:blue">2.1. Can you show with the parameter estimates that the books are getting longer on average?</span>

<span style="color:blue">2.2. What is the uncertainty around the average book length? Does it change your conclusion?</span>
...
ChicagoCrime <- read.csv("https://www.math.ntnu.no/emner/ST2304/2024v/Module05/NoFreezeTempCrimeChicago.csv")
str(ChicagoCrime)
```
