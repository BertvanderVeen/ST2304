...
You should work through the exercise in groups and write answers in a separate document to be submitted on Blackboard by **Friday 3rd Feb midnight (or another date)**. 
...
Their data can be found at (https://www.math.ntnu.no/emner/ST2304/2024v/Module03/DragonEggData.csv).
...
SexRatioData <- read.csv('https://www.math.ntnu.no/emner/ST2304/2024v/Week03/DragonEggData.csv', header=T) 
...
plot(lambdas, likelihoods.Pois, type="l", ylab="Likelihood", xlab="Number of dragons")
