...
$$
l(\alpha, \beta, \sigma^2;\mathbf{y},\mathbf{x}) = - \frac{n}{2} \log{\sigma^2} - \sum_{i=1}^n 
...
```{r ReadTimes}
Times <- read.csv('https://www.math.ntnu.no/emner/ST2304/2024v/Module05/Times.csv', header=T)
```
