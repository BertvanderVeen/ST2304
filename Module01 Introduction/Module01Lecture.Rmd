...
- Reference Group (>3 students)

- Blackboard
- Webpage: https://www.ntnu.no/studier/emner/ST2304
- wiki: https://wiki.math.ntnu.no/st2304/2024v/start
...
https://www.menti.com/alx4sq1y6cvu

![](mentimeter_qr_codeVirtual.png){height=70%}

## Teachers

Bert van der Veen (me)

Bob O'Hara (here, but not here)
...
\textbf{Discussion board}
https://mattelab2024v.math.ntnu.no/c/st2304/15

\textbf{Webpage}(this includes other links from this presentation)
https://wiki.math.ntnu.no/st2304/2024v/start
...
- Come up with 3 topics you learned about in \textbf{ST0103}, and examples where they are used in biology/biotechnology
- Add the topics to TaskCard: https://ntnu.taskcards.app/#/board/3696eff3-b77d-4107-b7a8-fc4c03ef9f1c
